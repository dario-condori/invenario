            ...
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div> <p><br></p>
                    <h3 class="fw-bold mb-3">
                        ...
                        <a href="{{route('comercio.reporte.mensual',['fecha_comercio'=>date('Y-m-d', strtotime($fanterior))])}}" class="btn btn-secondary btn-sm" >
                            <span class="btn-label"><i class="fas fa-angle-double-left"></i></span>
                            Anterior mes
                        </a>
                        <a href="{{route('comercio.reporte.mensual',['fecha_comercio'=>date('Y-m-d', strtotime($fsiguiente))])}}" class="btn btn-secondary btn-sm">
                ...
                <div class="col-md-10">
                    <div class="table-responsive">
                        <table class="table table-bordered table-head-bg-secondary table-bordered-bd-secondary mt-4 table-hover">
                            <thead>
                                <tr>
                                    <th colspan="5" scope="col" class="text-center">ESTADO MENSUAL</th>
                                </tr>
                                <tr>
                                    <th scope="col">Nro.</th>
...
@section('javascripts')
    <script>
        document.getElementById('mReporteMensual').classList.add('active');
