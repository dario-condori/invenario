                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="{{old('vuelta', $nro+1)}}" name="vuelta" id="vuelta" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="{{old('transporte', 0)}}" name="transporte" id="transporte" placeholder="..." required/>
